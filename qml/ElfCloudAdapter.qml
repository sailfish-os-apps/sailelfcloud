...
Python {
    ...
    Component.onCompleted: {
        if (!py._ready) {
            ...
            addImportPath(Qt.resolvedUrl("../3rd/usr/lib/python3.4/site-packages/"));
            addImportPath(Qt.resolvedUrl("../3rd/decorator-4.0.9-py3.4.egg"));
            addImportPath(Qt.resolvedUrl("../3rd/elfcloud_weasel-1.2.2-py3.4.egg"));
